...
class CallClassifierAPIAction(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        response = requests.post('http://https://180b-45-241-137-207.ngrok-free.app:8080/predict', json={'text': combined_feelings})
        print(response)
...
class CallClassifierAPIAction_2(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        response = requests.post('https://180b-45-241-137-207.ngrok-free.app:8080/predict', json={'text': combined_feelings})
        print(response)
        # Process the API response
        if response.status_code == 200:
            output = response.json()
